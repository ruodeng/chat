...
async function handleRequest(request: Request, env: Env): Promise<Response> {
  ...
  // ============ Static Pages ============
  if (path === '/about') {
    return new Response(getPageHTML('about'), { headers: { 'Content-Type': 'text/html; charset=utf-8' } });
  }
  if (path === '/privacy') {
    return new Response(getPageHTML('privacy'), { headers: { 'Content-Type': 'text/html; charset=utf-8' } });
  }
